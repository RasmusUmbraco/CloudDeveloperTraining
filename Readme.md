...
In order to run Umbraco locally you will need to [install the .NET 9.0 SDK](https://dotnet.microsoft.com/download) (if you do not have this already).
...
```
dotnet new classlib --name MyAwesomeProject.Code --output src/MyAwesomeProject.Code -f net9.0
